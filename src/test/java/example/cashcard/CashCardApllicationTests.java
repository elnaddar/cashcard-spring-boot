...
class CashCardApllicationTests {
    ...
    void shouldNotReturnACashCardWithAnUnknownId() {
        ResponseEntity<String> respose = restTemplate
                .withBasicAuth("sarah1", "abc123")
    ...
    void shouldReturnAllCashCardsWhenListIsRequested() {
        ...
        assertThat(amounts).containsExactlyInAnyOrder(0.0, 1.0, 150.00);
    }
    ...
    void shouldReturnASortedPageOfCashCards() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards?page0&size=1&sort=amount,desc",
                        String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    ...
    void shouldRejectUsersWhoAreNotCardOwners() {
        ResponseEntity<String> response = restTemplate
                .withBasicAuth("hank-owns-no-card", "123abc")
                .getForEntity("/cashcards/99", String.class);
